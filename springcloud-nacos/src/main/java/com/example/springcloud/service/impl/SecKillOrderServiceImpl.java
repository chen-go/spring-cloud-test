...
import com.example.springcloud.common.cache.LocalCache;
import com.example.springcloud.common.constant.RedisKeyPrefixConst;
import com.example.springcloud.domain.*;
import com.example.springcloud.exception.BusinessException;
import com.example.springcloud.mapper.LightningTestMapper;
...
import com.example.springcloud.service.SecKillOrderService;
import com.example.springcloud.util.RedisOpsUtil;
...
//    private TradeService tradeService;
    ...
    @Autowired
    private LightningTestMapper lightningTestMapper;
...
//        result.setMemberReceiveAddressList(memberReceiveAddressList);
        ...
        promotionItem.setProductId(1111l);//产品ID
        promotionItem.setProductName("测试");//产品名称
...
//        CommonResult<PmsProductParam> commonResult = pmsProductFeignApi.getProductInfo(productId);
        CommonResult<PmsProductParam> commonResult = null;
    ...
    public Integer test(LightningTestPO lightningTestPO) {

//        String s = redisOpsUtil.get(RedisKeyPrefixConst.MIAOSHA_STOCK_CACHE_PREFIX + lightningTestPO.getId());
//        System.out.println(s);
        redisOpsUtil.set(RedisKeyPrefixConst.MIAOSHA_STOCK_CACHE_PREFIX + lightningTestPO.getId(),lightningTestPO.getStock()+"");
//        Integer deduction = lightningTestMapper.deduction(lightningTestPO);
//        return deduction;
        return 1;
    }
